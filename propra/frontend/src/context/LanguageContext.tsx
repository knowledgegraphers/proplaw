...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "landing.hero.sub": "Navigate Germany's complex building law with AI-powered guidance backed by exact legal sources — LBO, BauGB, BauNVO, and more.",
    ...
    "landing.feat2.desc": "Every answer is backed by specific §§ from LBO, BauGB, BauNVO, and other German building codes.",
  ...
  de: {
    ...
    "landing.hero.sub": "Navigieren Sie durch das komplexe deutsche Baurecht mit KI-gestützter Beratung auf Basis exakter Rechtsquellen — LBO, BauGB, BauNVO und mehr.",
    ...
    "landing.feat2.desc": "Jede Antwort wird durch spezifische §§ aus LBO, BauGB, BauNVO und anderen Baugesetzen belegt.",
