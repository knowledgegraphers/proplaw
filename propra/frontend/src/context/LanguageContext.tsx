...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "landing.hero.sub": "Navigate Germany's complex building law with AI-powered guidance backed by exact legal sources.",
  ...
  de: {
    ...
    "landing.hero.sub": "Navigieren Sie durch das komplexe deutsche Baurecht mit KI-gestützter Beratung auf Basis exakter Rechtsquellen.",
