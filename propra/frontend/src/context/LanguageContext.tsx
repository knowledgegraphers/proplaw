...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "advisor.placeholder": "Ask your building question… e.g. 'Can I build a fence along my property boundary?'",
    "advisor.send": "Ask",
  ...
  de: {
    ...
    "advisor.placeholder": "Stellen Sie Ihre Baufrage… z.B. 'Darf ich entlang meiner Grundstücksgrenze einen Zaun bauen?'",
    "advisor.send": "Fragen",
